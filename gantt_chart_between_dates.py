...
print(" i mesi gennaio, marzo, maggio, luglio, agosto,ottombre e dicembre hanno 31 giorni, gli altri 30. Febbraio 28")
...
def gantt_chart_between_2_date(data_1, data_2):
    dict_from_dates = from_csv_to_gant_chartt("C://Users//mmmel//Desktop//nodes_disc.csv")
...
gantt_chart_between_2_date(date_1, date_2)
